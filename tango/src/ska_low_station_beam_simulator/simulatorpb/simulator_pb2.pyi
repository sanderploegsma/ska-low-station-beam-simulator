...
class StartScanRequest(_message.Message):
    __slots__ = ("obs_time_epoch_s", "scan_duration_s", "scan_id", "subarray_id", "beam_id", "num_channels", "tone_sources", "noise", "start_channel", "negate_delay")
    ...
    NEGATE_DELAY_FIELD_NUMBER: _ClassVar[int]
